...
router.get("/:id/catalogo", obtenerCatalogoPorActor);
router.get("/:id/catalogo/titulo/:titulo", obtenerCatalogoPorActorYTitulo);
router.get("/:id/catalogo/tipo/serie", obtenerCatalogoPorActorYTipoSerie);
router.get("/:id/catalogo/tipo/pelicula", obtenerCatalogoPorActorYTipoPelicula);
